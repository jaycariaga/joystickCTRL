...
const int mouseEnable = 2;        // switch to turn on and off mouse control
const int mouseLeftButton = 3;    // input pin for the mouse pushButton
...
//below should be trying somethig new
  if (reading < 755){
    reading = map(reading,0,760,0,512);
    }
   else{
    if(reading < 780){
      reading = 512;
      ...
      reading = map(reading, 765, 1023,513,1023);
      }
    }
